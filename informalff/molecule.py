...
class Molecule(object):
    ...
    def _is_stereocenter(self, i : int) -> bool:
        ...
        -------
        bool
            True if the atom is a stereocenter, False otherwise
        """
        # If the bond list hasn't been created
        ...
        # If there's four neighbors, only a non-planar structure
        # could lead to a stereocenter
    ...
    def is_chiral(self) -> bool:
        ...
        This method will check if the molecule is chiral. To do
        so, it will check if any of the atoms is chiral.
